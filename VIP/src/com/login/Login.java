...
import com.admin.Forgotadp;
import com.admin.Forgotadu;
import com.student.Studash;
...
public class Login implements ActionListener{
	...
	public Login() throws Exception{
		login= new JFrame("Login_page_BNBC_J2SE");
													ImageIcon Background= new ImageIcon("image/backk.jpg");
		...
		title.add(vip);
													ImageIcon log= new ImageIcon("image/log.png");
