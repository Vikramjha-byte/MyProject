...
public class Resultadd implements ActionListener {
	...
	public Resultadd() throws Exception {
		...
		/*
		 * exam.setForeground(new Color(247,202,24)); exam.setBackground(new
		 * Color(0,0,0)); exam.setCaretColor(new Color(247,202,24));
		 * exam.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * reg.setForeground(new Color(247,202,24)); reg.setBackground(new
		 * Color(0,0,0)); reg.setCaretColor(new Color(247,202,24));
		 * reg.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * fullname.setForeground(new Color(247,202,24)); fullname.setBackground(new
		 * Color(0,0,0)); fullname.setCaretColor(new Color(247,202,24));
		 * fullname.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * fathername.setForeground(new Color(247,202,24)); fathername.setBackground(new
		 * Color(0,0,0)); fathername.setCaretColor(new Color(247,202,24));
		 * fathername.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * mothername.setForeground(new Color(247,202,24)); mothername.setBackground(new
		 * Color(0,0,0)); mothername.setCaretColor(new Color(247,202,24));
		 * mothername.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * totalscore.setForeground(new Color(247,202,24)); totalscore.setBackground(new
		 * Color(0,0,0)); totalscore.setCaretColor(new Color(247,202,24));
		 * totalscore.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		/*
		 * percentage.setForeground(new Color(247,202,24)); percentage.setBackground(new
		 * Color(0,0,0)); percentage.setCaretColor(new Color(247,202,24));
		 * percentage.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		 * Color(247,202,24)));
		 */
		...
		// Mark5.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		// Color(247,202,24)));*/
		...
		// Mark6.setBorder(BorderFactory.createMatteBorder(0,0,5,0,new
		// Color(247,202,24)));*/
		...
		// back.setBorder(BorderFactory.createMatteBorder(0, 0, 5, 0, new
		// Color(0,0,0)));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == add) {
			...
			try {
				...
				String sql;
				sql = "INSERT INTO result(rollno,examyear,nameofexam,sub1,sub2,sub3,sub4,sub5,sub6,percentage) VALUES ('"
						+ l + "','" + m + "','" + f + "','" + pop + "','" + mum + "','" + mi + "','" + mu + "','" + mo
						+ "','" + smobile + "','" + sd + "')";
