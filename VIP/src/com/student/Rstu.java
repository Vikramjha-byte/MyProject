...
public class Rstu implements ActionListener{
	JFrame screen;
	...
	// Date sm;
	 String f,l,m,pop,mum,sm,smobile,fmobile,mmobile,Foccupp,Moccupp,Maddresss,Faddresss,almuni,session,mail,user,pas,reg,gend,branchh,statess,Areaa,Nationn,pic,regis;
	public Rstu() throws Exception{
...
combobox1.setVisible(true);
			 ...
			 if(e.getSource()==register){
			  ...
			  //System.out.println(f+l+m+pop+mum+sd+smobile+fmobile+mmobile+Foccupp+Moccupp+Maddresss+Faddresss+session+mail+user+pas+reg+gend+branchh+statess+Areaa+Nationn);
		        JOptionPane.showMessageDialog(screen,"STUDENT DELETED SUCCESSFULLY");
