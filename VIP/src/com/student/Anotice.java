...
public class Anotice implements ActionListener {
	...
	public Anotice() throws Exception {
		screen = new JFrame();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == add) {
			...
			Date BirthDate = chooser.getDate();
			...
			try {
				...
				String sql;
				sql = "INSERT INTO notice(title,description,branch,year,almuni,date,type) VALUES ('" + f + "','" + l
						+ "','" + m + "','" + pop + "','" + mum + "','" + sd + "','" + smobile + "')";
